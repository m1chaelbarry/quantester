...
| **3** | [`market_data/`](market_data/) | Yahoo / crypto live feeds | `python examples/market_data/run.py` |
...
| [`market_data/`](market_data/) | Live yfinance / CCXT via `load_yahoo` / `load_crypto` | `python examples/market_data/run.py` |
